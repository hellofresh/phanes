...
The following is a set of guidelines for contributing to Phanes and its packages, 
...
We accept contributions via Pull Requests on [Github](https://github.com/hellofresh/phanes).

## How Can I Contribute?

### Reporting Bugs

This section guides you through submitting a bug report for Phanes. Following these guidelines helps maintainers 
...
* **Describe the exact steps which reproduce the problem** in as many details as possible. For example, start by explaining how you started Phanes, 
...
* **Which version of Phanes are you using?**
* **What's the name and version of the OS you're using**?

### Your First Code Contribution

Unsure where to begin contributing to Phanes? You can start by looking through these `beginner` and `help-wanted` issues:
